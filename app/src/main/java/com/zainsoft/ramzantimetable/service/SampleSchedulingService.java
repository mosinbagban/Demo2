...
public class SampleSchedulingService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            Log.i(TAG, getString(R.string.cast_notification_disconnect));
        }
    
        // If the app finds the string "doodle" in the Google home page content, it
        // indicates the presence of a doodle. Post a "Doodle Alert" notification.
        if (result.indexOf(SEARCH_STRING) != -1) {
            sendNotification(getString(R.string.sunrise));
            Log.i(TAG, "Found doodle!!");
        } else {
            sendNotification(getString(R.string.sunset));
    ...
    private void sendNotification(String msg) {
        ...
        .setContentTitle(getString(R.string.accept))
