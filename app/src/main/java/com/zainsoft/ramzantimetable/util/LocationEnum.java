...
import com.zainsoft.ramzantimetable.R;
 ...
 enum LocationEnum {
    MENU_ARAK(1, 18.52, 73.85), MENU_ARDABIL(2, 18.52, 73.85), MENU_ORUMIYEH(3,
            18.52, 73.85), MENU_ESFEHAN(4, 18.52, 73.85), MENU_AHVAZ(5, 18.52,
            73.85), MENU_ILAM(6, 33.63, 46.42), MENU_BOJNURD(7, 37.47, 57.33), MENU_BANDAR_ABAS(
